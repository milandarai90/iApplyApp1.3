...
class cancel_booking_services{
  Future<cancel_booking_response> cancel_booking(cancel_booking_request requestCancelBooking,String token)async{
    final url = "https://iapply.techenfield.com/api/cancelBookings?consultancy_id=${requestCancelBooking.consultancy_id}&branch_id=${requestCancelBooking.branch_id}&course_id=${requestCancelBooking.course_id}&classroom_id=${requestCancelBooking.classroom_id}";
