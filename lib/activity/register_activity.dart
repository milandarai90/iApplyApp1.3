    ...
    try{
      if(form_key.currentState!.validate()){
        ...
        if(response.statusCode == 200 ){
          ...
          if(context.mounted){
            Navigator.push(context, MaterialPageRoute(builder: (context)=>verifyOTP_activity(email : emailController.text ,name : nameController.text , password : passwordController.text , cPassword : cPasswordController.text)));
          }
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(backgroundColor:Colors.red,content: Center(child: Text("Someting went wrong"),)));
        }
        finally{
      if(mounted)
        setState(() {
